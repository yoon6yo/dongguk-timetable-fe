 ...
 * MySQL hourly, so there's no need for every page load across every visitor
 * to hit the DB fresh — this absorbs repeated requests within the TTL
 * window with a single in-memory value.
 *
